...
class DepartmentsControllerTest < ActionController::TestCase
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post :create, department: { head_id: @department.head_id, name: @department.name }
    end
  ...
  test "should update department" do
    patch :update, id: @department, department: { head_id: @department.head_id, name: @department.name }
    assert_redirected_to department_path(assigns(:department))
  end
